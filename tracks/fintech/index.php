...
<main id="barba-wrapper">
  <div class="barba-container">
    ...
    <div class="text">
        ...
        <p style="margin-top:100px;">The financial sector is filled with old legacy systems and deep rooted traditions where often the status quo prevails. These conditions make the industry particularly favorable for disruption allowing software and technology to potentially play a huge role in making existing financial services more efficient. If money is your thing apply now!</p>
