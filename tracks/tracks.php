...
<main id="barba-wrapper">
  <div class="barba-container">
    <header style="background-image: url(images/2.jpg);">
      <h1><?php echo $tracks[$track_name]['title']; ?></h1>
    </header>
    ...
    <a class="barba-nav next" href="3.html"  style="background-image: url(images/3.jpg);"></a>
    <a class="barba-nav prev" href="index.html"  style="background-image: url(images/1.jpg);"></a>
  </div>
</main>
